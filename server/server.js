...
const checkJwt = jwt({
  ...
  secret: jwks.expressJwtSecret({
    ...
    jwksUri: `https://flannj.auth0.com/.well-known/jwks.json`
  }),
  // Validate the audience and the issuer.
  audience: 'https://flannj.auth0.com/api/chucknorris', //change per API
  issuer: `https://flannj.auth0.com/`,
  algorithms: ['RS256']
});
...
app.get('/api/jokes/celebrity', checkJwt, (req,res) => {
  let CelebrityJokes = [
  {
    id: 88881,
